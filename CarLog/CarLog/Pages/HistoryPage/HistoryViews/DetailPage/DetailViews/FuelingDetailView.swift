...
class FuelingDetailView: UIView {
    ...
    lazy var upDateButton: UIButton = {
        ...
        upDateButton.customButton(text: "수정", font: UIFont.spoqaHanSansNeo(size: Constants.fontJua20, weight: .medium), titleColor: .mainNavyColor, backgroundColor: .buttonSkyBlueColor)
    ...
    private func setupUI() {
        addSubview(fuelingDetailPageLabel)
        ...
        fuelingDetailPageLabel.snp.makeConstraints { make in
        ...
        inputFuelingStackView.snp.makeConstraints { make in
            make.top.equalTo(fuelingDetailPageLabel.snp.bottom).offset(30)
            make.leading.equalTo(safeAreaLayoutGuide).offset(Constants.horizontalMargin)
            make.trailing.equalTo(safeAreaLayoutGuide).offset(-Constants.horizontalMargin)
        }
