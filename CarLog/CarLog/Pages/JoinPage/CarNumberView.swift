...
class CarNumberView: UIView {
    ...
    lazy var carNumberTextField: UITextField = {
        ...
        textField.loginCustomTextField(placeholder: "차량번호 입력", textColor: .lightGray, font: Constants.fontJua16 ?? UIFont(), alignment: .left, paddingView: UIView(frame: CGRect(x: 0, y: 0, width: 15, height: textField.frame.size.height)))
        return textField
    }()
