...
class CalendarView: UIView {
    ...
    private func customButton(text: String) -> UIButton {
        let button = UIButton()
        button.customButton(text: text, font: UIFont.spoqaHanSansNeo(size: Constants.fontSize20, weight: .semibold), titleColor: .mainNavyColor, backgroundColor: .buttonSkyBlueColor)
